<!-- DELETE POP UP FORM -->
<div class="modal fade" id="Delete_Official<?php echo $row['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
   aria-hidden="true">
      ...
      <div class="modal-content">
         ...
         <form action="function.php" method="POST">
            ...
            <div class="modal-footer">
               ...
               <button type="submit" name="delete_official" class="btn btn-danger">Delete</button>
            </div>
         </form>
      </div>
   </div>
